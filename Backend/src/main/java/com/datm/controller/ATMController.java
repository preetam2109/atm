...
public class ATMController {
	...
	public ResponseEntity<String> withdraw(@RequestParam(value="cardNumber") int cardNumber, @RequestParam(value="pin") int pin , @RequestParam(value="amount") double amount)
	{
